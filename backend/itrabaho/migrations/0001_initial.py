# Generated by Django 3.2.12 on 2022-02-22 15:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("E", "Employed"), ("U", "Unemployed")], max_length=1
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.CharField(
                        choices=[("M", "Match"), ("R", "Review"), ("A", "Accepted")],
                        max_length=1,
                    ),
                ),
                ("datetimeCreated", models.DateTimeField(auto_now_add=True)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to="itrabaho.lgurepresentativemodel",
            ),
        ),
        migrations.AddField(
            model_name="applicantmodel",
            ...
            field=models.OneToOneField(
                on_delete=django.db.models.deletion.CASCADE, to="itrabaho.profilemodel"
            ),
        ),
        migrations.AddField(
            model_name="applicantmodel",
